...
class App(tk.Tk):
    ...
    def _show_help(self):
        ...
        help_text = (
            ...
            "  generating.\n\n"
            "Wonderware 2023+\n"
            "  When checked, applies the 128-character tag name limit used by\n"
            "  Wonderware 2023 and later. When unchecked, the 32-character\n"
            "  limit for Wonderware 2020 and earlier is used. This setting\n"
            "  affects Generate, Dry run, and Check Tag Length.\n\n"
            "Filter\n"
            ...
            "  output CSV file (unless Dry run is checked). Automatically\n"
            "  checks each device's HMI_TAG value length against its template\n"
            "  and reports a warning in the log if any value exceeds the limit\n"
            "  set by the Wonderware 2023+ checkbox.\n\n"
            "List Templates\n"
            ...
            "Check Tag Length\n"
            "  Reports the maximum number of characters the HMI_TAG value can\n"
            "  be for each template sheet, based on the fixed characters\n"
            "  surrounding the HMI_TAG placeholder in each tag row. Uses the\n"
            "  limit set by the Wonderware 2023+ checkbox. Run this as a\n"
            "  precheck to know your per-template limits before generating.\n\n"
            "UDT IMPORT\n"
            "----------\n"
            "UDT (.L5X)\n"
